...
<div class="box">
    ...
    <div class="box-header">
        <a href="{{ asset('/incentives/new') }}"><i class="fa fa-arrow-circle-left"></i><font color="grey" size="3">&nbsp;&nbsp;<u>Back to Incentive Requests</u></font></a>
    </div>
    <div class="box-body">
    ...
    <div style="float: right; width: 200px; text-align: center;" class="box-body">
        <b><?php echo strtoupper($rows->status); ?></b>
    </div>
    <div class="box-body">
        ...
        <form method="POST" action="{{ asset('/incentives/update') }}" role="form">
            ...
            <table class="table table-bordered"  style="width: 900px;">
                ...
                <tbody  id="myTable">
                    ...
                    if($rows->status == 'pending'){
                        if($userId == '21225273' || $userId == '21464812'){
                            foreach($contents as $content){
                                print '<tr>';
                                    print '<td><input type="text" readonly class="form-control" name="description[]" value="'.$content->description.'"></td>';
                                    ...
                                    echo '<td>';
                                                echo '<select type="text" class="form-control" name="availability[]" value="'.$content->availability.'">';
                            ...
                            foreach($contents as $content){
                                ...
                                print '<td style="text-align: center;">'.$content->availability.'</td>';
                                print '</tr>';
                                $total += $content->total_amount;
                            }
                        }
                    ...
                    <tr>
                        ...
                        <td>
                            @if($userId == '21225273' || $userId == '21464812')
                            <input type="text" class="form-control" id="totalamt" value="<?php echo number_format($total, 2); ?>">
                            @else
                            <input type="text" readonly class="form-control" id="totalamt" value="<?php echo number_format($total, 2); ?>">
                            @endif
                        </td>
                        ...
                        <td colspan="2" style="color: #a0a0a0 ">
                             <i><?php 
                                if($rows->quoted_by!=' '){
                                    ...
                                    echo '<br>';
                                    echo date("F j, Y - H:i A", $rows->date_quoted); 
                                }
                                ?></i>
                        </td>
                    </tr>
        ...
        <div class="box-body" style="width: 765px; border: 1px solid; border-color: #e4e4e4;">
            <form method="POST" action="{{ asset('/incentives/process') }}" role="form">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" value="{{$rows->id}}" name="id">
            ...
            @if($rows->status == 'pending')
                ...
                <form method="POST" action="{{ asset('/incentives/addremarks') }}" role="form">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" value="{{$rows->id}}" name="id">
        ...
        <div class="box-body">
            <?php
                $remarks = DB::table('iris_forms_remarks')->where('iris_id', $rows->id)->get();     
