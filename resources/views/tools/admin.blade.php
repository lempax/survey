...
<!--                <select class="form-control" style="width: 300px; float: left;">
                ...
                <input type="submit" name="generate" class="btn btn-block btn-success" style="width: 200px; float: left; margin-left: 5px;" value="Generate Data">
