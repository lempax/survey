                    ...
                    <form method="POST" id="search-form" class="form-inline" role="form">
                        ...
                        <div class="form-group">
                            <select class="form-control" aria-controls="weeks" id="week_selector" name="week_selection">
                                ...
                                $_m = date('m', mktime(0,0,0,$m, 1, date('Y'))); 
                                ?>
                                @if(Request::has('w'))
                                    <option value="{{ $_m }}" {{ $m == Request::get('w') ? 'selected' : '' }}> {{ $month }}</option>
                                @else
                                    <option value="{{ $_m }}" {{ $max == $_m ? 'selected' : '' }}>{{ $month }}</option>
                                @endif
                                @endfor
                            </select>
                        </div>
                        <div class="form-group">
                            <select class="form-control" aria-controls="year" id="year_selector" name="year_selection">
