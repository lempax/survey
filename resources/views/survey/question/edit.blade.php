...
<div class="box box-primary">
    <div class="box-body">
        <a href='home' class="btn bg-info margin-bottom">Back to Surveys</a>
        <div class="box box-primary box-solid">
            <div class="box-header with-border"><span class="box-title" style="font-size: 16px; display: block">Edit Question</span></div>
            <div class="box-body">
                <form method="POST" action="{{ URL('question/'.$question->id.' ') }}/update" id="boolean">
                    ...
                    <div class="text-div" style="margin-bottom: 5px;">
                        ...
                        <input name="title" id="title" type="text" placeholder="Type question here" value="{{ $question->title }}" class="form-control" style="border-radius: 4px;">
                    </div>
                    ...
                    <div class="text-div" style="margin-top: 15px;">
                        <button type="button" class="btn btn-default add-option" style="cursor:pointer; display: none;"><i class="fa fa-plus"></i> New Option</button> &nbsp;
                        ...
                        <a href="#doDelete" style="float:right;" class="btn btn-danger">Delete Survey</a> 
                        <button class="btn btn-primary waves-effect waves-light" style="float: right; margin-right: 5px;">Submit Survey</button>
                    </div>
                </form>
            </div>
        </div>
