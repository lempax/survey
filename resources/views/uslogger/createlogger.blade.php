...
<meta name ="csrf-token" content = "{{ csrf_token() }}"/>
    <div class="box">
        <div class="box-body">
            <form action="{{url('/uslogger/store')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group">
                    <table>
                        <h4>Input details below:</h4><hr>
                    <div class="row">
                        <div class="col-md-4">
                        Team<br>
                        ...
                        Order Date:<br>
                        <input class="form-control" type="date" name="orderdate" required><br>

                        Case ID:<br>
                        <input class="form-control" type="text" name="caseid" required><br>

                        Contract ID:<br>
                        <input class="form-control" type="text" name="contractid" required><br>

                        Product Description:<br>
                        <input class="form-control" type="text" name="desc" required><br>
                    ...
                    <button type="submit" class="btn bg-blue btn-sm"><i class="fa fa-sticky-note-o"></i> Submit</button>
